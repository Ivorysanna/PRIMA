            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, imgSpriteSheet.load("../../MarioGame/Images/CharacterSheet/MarioSpriteSheet.png")];
                    case 1:
                        _a.sent();
                        coat = new ƒ.CoatTextured(undefined, imgSpriteSheet);
                        animation = new ƒAid.SpriteSheetAnimation("Walk", coat);
                        animation.generateByGrid(ƒ.Rectangle.GET(1, 0, 140, 220), 8, 22, ƒ.ORIGIN2D.BOTTOMCENTER, ƒ.Vector2.X(55));
